...
function autoBind(instance: Record<string, (...args: unknown[]) => void>) {
...
class Title {
  ...
  constructor({ gl, plane, renderer, text, textColor = '#545050', font = '30px sans-serif' }: TitleProps) {
    autoBind(this as unknown as Record<string, (...args: unknown[]) => void>);
    this.gl = gl;
    this.plane = plane;
...
class Media {
  ...
  constructor({ geometry, gl, image, index, length, renderer, scene, screen, text, viewport, bend, textColor, borderRadius, font }: MediaProps) {
...
class App {
  ...
  constructor(container: HTMLDivElement, options: AppOptions) {
  ...
  onWheel(e: WheelEvent) {
    const delta = e.deltaY || ('wheelDelta' in e ? (e as WheelEvent & { wheelDelta: number }).wheelDelta : 0) || ('detail' in e ? (e as WheelEvent & { detail: number }).detail : 0);
